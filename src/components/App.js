...
componentWillMount(){
  ...
  .then((json) => {
    console.log("Data from the fetched info is right here", json)
          ...
          <div className="card-block">
            ...
            <div>
              ...
              <div>
                ...
                <h6 className="card-subtitle mb-2 text-muted">Vehicle Class: {vehicle.vehicle_class}</h6>
                <h6 className="card-subtitle mb-2 text-muted">Passenger Capacity: {vehicle.passengers}</h6>
                <h6 className="card-subtitle mb-2 text-muted">Crew Capacity: {vehicle.crew}</h6>
                <h6 className="card-subtitle mb-2 text-muted">Vehicle Length: {vehicle.length}</h6>
